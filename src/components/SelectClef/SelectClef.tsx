    ...
    return (
        <main className="align-center flex flex-col items-center">
            ...
            <div className="flex flex-col items-center mt-4">
                ...
                <button className="bg-primary text-white w-56 text-center flex items-center justify-center rounded-full px-4 py-2 m-2 hover:bg-primary-dark transition duration-300" onClick={() => onClickClef("bass-clef")}>
                    Clave de Fá
